...
<head>
    ...
    <title>Ges stock @yield('title')</title>

    <!-- Custom fonts for this template-->
    <link href="{{ asset('accueil/vendor/fontawesome-free/css/all.min.css') }}" rel="stylesheet" type="text/css">
    <link
        href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i"
        rel="stylesheet">

    <!-- Custom styles for this template-->
    <link href="{{ asset('accueil/css/sb-admin-2.min.css') }}" rel="stylesheet">
...
<body id="page-top">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{route('users')}}">Gestion des utilisateurs</a>
                    </div>
                </div>
            </li>
    ...
    <script src="{{ asset('accueil/vendor/jquery-easing/jquery.easing.min.js') }}"></script>

    <!-- Custom scripts for all pages-->
    <script src="{{ asset('accueil/js/sb-admin-2.min.js') }}"></script>

    <!-- Page level plugins -->
    <script src="{{ asset('accueil/vendor/chart.js/Chart.min.js') }}"></script>

    <!-- Page level custom scripts -->
    <script src=" asset('accueil/js/demo/chart-area-demo.js') "></script>
    <script src=" asset('accueil/js/demo/chart-pie-demo.js') "></script>
